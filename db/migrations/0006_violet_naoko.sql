...
INSERT INTO `__new_semillas`("id", "variedad_id", "pais_origen_id", "distribuidor_id", "metodo_secado_id", "seleccion_id", "olor_id", "color_id", "integridad_id", "anexo_ruta", "anexo_tamano", "anexo_creacion", "fecha_creacion", "fecha_modificacion", "activo", "is_synced") SELECT "id", "variedad_id", "pais_origen_id", "distribuidor_id", "metodo_secado_id", "seleccion_id", "olor_id", "color_id", "integridad_id", "anexo_ruta", "anexo_tamano", "anexo_creacion", "fecha_creacion", "fecha_modificacion", "activo", "is_synced" FROM `semillas`;--> statement-breakpoint
DROP TABLE `semillas`;--> statement-breakpoint
ALTER TABLE `__new_semillas` RENAME TO `semillas`;--> statement-breakpoint
PRAGMA foreign_keys=ON;--> statement-breakpoint
ALTER TABLE `parcelas` ADD `activo` integer DEFAULT 1 NOT NULL;--> statement-breakpoint
ALTER TABLE `personal` ADD `activo` integer DEFAULT 1 NOT NULL;